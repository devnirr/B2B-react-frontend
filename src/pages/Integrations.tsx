...
export default function Integrations() {
  const [integrations] = useState([
    { id: 1, name: 'Shopify', type: 'E-commerce', status: 'Connected' },
    { id: 2, name: 'QuickBooks', type: 'Accounting', status: 'Connected' },
    { id: 3, name: 'ShipStation', type: 'Shipping', status: 'Disconnected' },
  ]);
    ...
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Manage third-party integrations</p>
        </div>
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {integrations.map((integration) => (
              <tr key={integration.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">{integration.type}</td>
                <td className="px-6 py-4 whitespace-nowrap">
