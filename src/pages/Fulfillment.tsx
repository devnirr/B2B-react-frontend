  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Fulfillment</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage order fulfillment and shipping</p>
        </div>
